...
@Component
public class ClienteDAO extends CrudDAO<Cliente, Long> {
  @Override public Class<Cliente> getTClass()   { return Cliente.class; }
  @Override public String        getTablePK()    { return "id"; }
  @Override public String        getTableName()  { return "clientes"; } // o "inmobiliaria.contratos"

  public Optional<Cliente> getClienteById(Long idContrato) {
